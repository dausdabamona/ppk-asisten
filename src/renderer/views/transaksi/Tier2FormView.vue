<template>
  <div class="tier2-form-container">
    <div class="page-header">
      <h1 class="page-title">Permintaan Tier 2</h1>
      <p class="page-subtitle">Form permintaan untuk kebutuhan yang belum terdapat di DIPA namun masih dalam lingkup MAK</p>
    </div>
    ...
    <form @submit.prevent="submitForm" class="form-card">
      <div class="form-group">
        ...
        <input 
          ...
          required
          class="form-input"
          placeholder="Contoh: Komputer untuk keperluan administrasi"
        />
      </div>
      ...
      <div class="form-group">
        ...
        <textarea 
          ...
          rows="4"
          class="form-input"
          placeholder="Jelaskan kebutuhan dan alasan permintaan"
        />
      </div>
      ...
      <div class="form-group">
        <label class="form-label required">MAK Terkait</label>
        <input 
          v-model="form.mak_code"
          type="text"
          required
          class="form-input"
  ...
  methods: {
    ...
    submitForm() {
      try {
        ...
        alert('Permintaan Tier 2 berhasil disimpan!');
